...
License Node React MongoDB# 🛡️ SalamaNet — Safety Toolkit for Kenyan Girls
...
- [Roadmap](#-roadmap)
- [The Team](#-the-team)
- [Kenya Safety Resources](#-kenya-safety-resources)
- [License](#-license)
...
1. **Detect** — identify AI-manipulated media before it causes harm
2. **Alert** — instantly notify trusted contacts when danger is near
3. **Document** — build a legally valid evidence record for reporting and prosecution
...
- [x] Simulated deepfake detection with rule-based engine
- [x] One-button SOS emergency alerts with GPS
- [x] Evidence locker with file uploads and categories
- [x] Legal PDF report export with chain of custody
- [x] Emergency contacts management
- [x] PWA — installable and offline-capable
- [x] Security hardening (rate limiting, Helmet, XSS, NoSQL injection)
- [x] 44-test automated test suite
